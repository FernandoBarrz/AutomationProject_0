...
from webex_bot.commands.CSVCommand import CSVCommand
...
#        self.add_command(CSVCommand())
    ...
    def process_incoming_message(self, teams_message, activity):
        ...
        :return:
        """
        log.debug("Message received from Webex to bot object:")
        log.debug(teams_message)
        user_email = teams_message.personEmail
        raw_message = teams_message.text
        self.files = teams_message.files
        
        # if(teams_message.files>-1):
        #     log.info("Files founds")
