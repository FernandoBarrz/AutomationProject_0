...
class CSVCommand(Command):
    ...
    def pre_execute(self, message, attachment_actions, activity):
        log.warning(f"CSV text is {self.text}")
        """
        (optional function).
        ...
        text1 = TextBlock("Im processing your CSV. Please wait...", weight=FontWeight.BOLDER, wrap=True, size=FontSize.DEFAULT,
                          horizontalAlignment=HorizontalAlignment.CENTER, color=Colors.DARK)
        text2 = TextBlock("I'm working my magic behind the scenes. This humble bot asks you to be patient :)",
    ...
    def execute(self, message, attachment_actions, activity):
        ...
        log.warning(f"Received on CSV command: {self.text}")
